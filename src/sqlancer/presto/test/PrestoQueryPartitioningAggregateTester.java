...
public class PrestoQueryPartitioningAggregateTester extends PrestoQueryPartitioningBase
    ...
    public void check() throws SQLException {
        ...
        NewFunctionNode<PrestoExpression, PrestoAggregateFunction> aggregate = new NewFunctionNode<PrestoExpression, PrestoAggregateFunction>(aggregateArgs, aggregateFunction);
        ...
        if (firstResult == null && secondResult != null
                || firstResult != null &&
                (!firstResult.contentEquals(secondResult) && !ComparatorHelper.isEqualDouble(firstResult, secondResult))
        ) {
