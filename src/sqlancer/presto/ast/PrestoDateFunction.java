...
public enum PrestoDateFunction implements PrestoFunction {
    ...
    FROM_UNIXTIME_TIMEZONE("from_unixtime", PrestoDataType.TIMESTAMP_WITH_TIME_ZONE, PrestoDataType.INT, PrestoDataType.VARCHAR) {
        @Override
    ...
    FROM_UNIXTIME_HOURS_MINUTES("from_unixtime", PrestoDataType.TIMESTAMP_WITH_TIME_ZONE, PrestoDataType.INT, PrestoDataType.INT) {
        @Override
        public boolean shouldPreserveOrderOfArguments() {
            return true;
        }
    ...
    TO_ISO8601("to_iso8601", PrestoDataType.VARCHAR, PrestoDataType.DATE, PrestoDataType.TIMESTAMP, PrestoDataType.TIMESTAMP_WITH_TIME_ZONE),
...
//  date_trunc(unit, x) → [same as input]
    ...
    DATE_TRUNC_2("date_trunc", PrestoDataType.TIMESTAMP_WITH_TIME_ZONE, PrestoDataType.VARCHAR, PrestoDataType.TIMESTAMP_WITH_TIME_ZONE),
