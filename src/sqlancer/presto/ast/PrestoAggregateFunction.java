...
public enum PrestoAggregateFunction {
    ...
    PrestoAggregateFunction(int nrArgs, int maxNrArgs, List<PrestoSchema.PrestoDataType> supportedReturnTypes, List<PrestoSchema.PrestoDataType> supportedParamTypes) {
        this.nrArgs = nrArgs;
    ...
    public static List<PrestoAggregateFunction> getAggregates(PrestoSchema.PrestoDataType type) {
